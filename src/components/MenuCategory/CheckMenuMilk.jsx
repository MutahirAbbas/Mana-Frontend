...
import MilkProducts from "../Products/MilkProducts/MilkProducts";
export default function CheckMenuMilk() {
        ...
        <div className="col-lg-9 p-0 col-md-12 col-sm-12">
          <div className="uper-menu">
            ...
            <div className="mcc-boxes mcc-boxes-flex px-5">
              <div className="box active" onClick={toggleActiveMP}>
                <img src={MP} alt="" />
              ...
              <div className="box inactive" onClick={toggleActiveMP4}>
                <img src={Fat} alt="" />
